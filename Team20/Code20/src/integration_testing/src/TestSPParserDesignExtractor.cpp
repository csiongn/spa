...
TEST_CASE("Parser doesn't parse code with missing else branch", "[parser]") {
  GIVEN("A parser with a valid input sequence") {
	/*    SIMPLE Code
	 *
	 *    procedure main {
