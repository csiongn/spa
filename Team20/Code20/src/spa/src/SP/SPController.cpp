...
void SPController::insertRelationship(SimpleProgram::DesignAbstraction relationship, const std::unordered_map<int, std::unordered_set<int>>& map) {
    for (const auto& [key, value] : map) {
        insertRelationship(relationship, key, value);
    }
}

void SPController::insertRelationship(SimpleProgram::DesignAbstraction relationship, const std::unordered_map<int, std::unordered_set<std::string>>& map) {
    for (const auto& [key, value] : map) {
        insertRelationship(relationship, key, value);
    }
}

void SPController::insertRelationship(SimpleProgram::DesignAbstraction relationship, int key, const std::unordered_set<int>& value) {
    switch (relationship) {
...
void SPController::insertRelationship(SimpleProgram::DesignAbstraction relationship, int key, const std::unordered_set<std::string>& value) {
    switch (relationship) {
