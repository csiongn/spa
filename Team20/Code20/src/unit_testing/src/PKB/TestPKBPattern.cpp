...
TEST_CASE("PKB Pattern Test") {
    ...
    SECTION("AssignPartialPatternManager") {
        ...
        REQUIRE(checkVecValuesEqual(result, std::vector<size_t>{xPlusTwo->getHashValue(), x->getHashValue(), two->getHashValue()}));
        ...
        // "v + x * y + z * t"
        assignPartialPatternManager->insert(varX, vPlusXTimesYPlusZTimesT->getHashValue(), stmtNum, vPlusXTimesYPlusZTimesT);
