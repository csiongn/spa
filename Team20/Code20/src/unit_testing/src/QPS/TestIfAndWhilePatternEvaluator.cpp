...
TEST_CASE("If & While Pattern Evaluator") {
    SECTION("Evaluate entity evaluator with IDENT as left argument") {
        SECTION("WILDCARD right argument non-empty and correct statements") {
            ...
            PQL::Clause ifPatternClause = PQL::Clause(SimpleProgram::DesignAbstraction::PATTERN_IF, {ifSyn, lArgIfSyn, wildcardSyn, wildcardSyn});
            ...
            PQL::Clause whilePatternClause = PQL::Clause(SimpleProgram::DesignAbstraction::PATTERN_WHILE, {whileSyn, lArgWhileSyn, wildcardSyn, });
